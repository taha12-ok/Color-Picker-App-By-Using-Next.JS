...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-red-500 via-yellow-500 to-purple-500 dark:bg-gradient-to-r dark:from-indigo-500 dark:via-green-500 dark:to-pink-500">
